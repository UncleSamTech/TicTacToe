...
public class TicTacScreenGameObject {
    ...
    //Clears the board of all X's and O's when size has increased

    // set the given player at the given location on the game board.
    // the location must be available, or the board will not be changed.
    //This set move will be called when the size increases from 9 to 25
